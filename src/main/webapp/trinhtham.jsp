...
<%--    </a>--%>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="text-center display-4" style="margin-bottom: 30px"> <b> Trinh Thám </b></h3>
            <!-- Product Listings -->
            <div class="row row-cols-1 row-cols-md-4 g-4">
                <!-- Sản phẩm 1 -->
                <div class="col">
                    <div class="card product-card">
                        <img src="./img/TL04_SherLock.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Sherlock Holmes: The Complete Novels and Stories</h5>
                            <p class="card-text">Nhà cung cấp: NXB Trẻ<br>
                                Tác giả: Arthur Conan Doyle<br>
                                Nhà xuất bản: Trẻ</p>
                            <div class="input-group">
                                <input type="number" id="quantity-SP010" class="form-control" name="quantity" value="1"
                                       min="1">
                                <button type="button" class="btn btn-primary" onclick="addToCart('SP010')">Thêm vào giỏ
                                    hàng
                                </button>
                            </div>
                        </div>
                ...
                <div class="col">
                    <div class="card product-card">
                        <img src="./img/TL04_Murder.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            ...
                            <p class="card-text">Nhà cung cấp: NXB Trẻ<br>
                                ...
                                Nhà xuất bản: Trẻ</p>
                            <div class="input-group">
                                <input type="number" id="quantity-SP011" class="form-control" name="quantity" value="1"
                                       min="1">
                                <button type="button" class="btn btn-primary" onclick="addToCart('SP011')">Thêm vào giỏ
                                    hàng
                                </button>
                            </div>
                        </div>
