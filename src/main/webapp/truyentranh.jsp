...
<%--    </a>--%>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="text-center display-4" style="margin-bottom: 30px"> <b> Truyện Tranh</b></h3>
            <!-- Product Listings -->
            <div class="row row-cols-1 row-cols-md-4 g-4">
                <!-- Sản phẩm 1 -->
                <div class="col">
                    <div class="card product-card">
                        <img src="./img/TL03_Doraemon.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Doraemon</h5>
                            <p class="card-text">Nhà cung cấp: NXB Trẻ<br>
                                Tác giả:Fujiko Fujio<br>
                                Nhà xuất bản: Trẻ</p>
                            <div class="input-group">
                                <input type="number" id="quantity-SP018" class="form-control" name="quantity" value="1"
                                       min="1">
                                <button type="button" class="btn btn-primary" onclick="addToCart('SP018')">Thêm vào giỏ
                                    hàng
                                </button>
                            </div>
                        </div>
                ...
                <div class="col">
                    <div class="card product-card">
                        <img src="./img/TL03_DragonBall.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">DragonBall</h5>
                            <p class="card-text">Nhà cung cấp: NXB Trẻ<br>
                                Tác giả: Akira Toriyama<br>
                                Nhà xuất bản: Trẻ</p>
                            <div class="input-group">
                                <input type="number" id="quantity-SP019" class="form-control" name="quantity" value="1"
                                       min="1">
                                <button type="button" class="btn btn-primary" onclick="addToCart('SP019')">Thêm vào giỏ
                                    hàng
                                </button>
                            </div>
                        </div>
                ...
                <div class="col">
                    <div class="card product-card">
                        <img src="./img/TL03_ToyStory.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">ToyStory</h5>
                            <p class="card-text">Nhà cung cấp: NXB Trẻ<br>
                                Tác giả: John Lasseter<br>
                                Nhà xuất bản: Trẻ</p>
                            <div class="input-group">
                                <input type="number" id="quantity-SP025" class="form-control" name="quantity" value="1"
                                       min="1">
                                <button type="button" class="btn btn-primary" onclick="addToCart('SP025')">Thêm vào giỏ
                                    hàng
                                </button>
                            </div>
                        </div>
                ...
                <div class="col">
                    <div class="card product-card">
                        <img src="./img/TL03_Dragonball01.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            ...
                            <p class="card-text">Nhà cung cấp: NXB Trẻ<br>
                                ...
                                Nhà xuất bản: Trẻ</p>
                            <div class="input-group">
                                <input type="number" id="quantity-SP024" class="form-control" name="quantity" value="1"
                                       min="1">
                                <button type="button" class="btn btn-primary" onclick="addToCart('SP024')">Thêm vào giỏ
                                    hàng
                                </button>
                            </div>
                        </div>
                ...
                <div class="col">
                    <div class="card product-card">
                        <img src="./img/TL03_naruto.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Naruto </h5>
                            <p class="card-text">Nhà cung cấp: NXB Trẻ<br>
                                Tác giả: Masashi Kishimoto<br>
                                Nhà xuất bản: Trẻ</p>
                            <div class="input-group">
                                <input type="number" id="quantity-SP023" class="form-control" name="quantity" value="1"
                                       min="1">
                                <button type="button" class="btn btn-primary" onclick="addToCart('SP023')">Thêm vào giỏ
                                    hàng
                                </button>
                            </div>
                        </div>
                ...
                <div class="col">
                    <div class="card product-card">
                        <img src="./img/TL03_Onepiece.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            ...
                            <p class="card-text">Nhà cung cấp: NXB Trẻ<br>
                                ...
                                Nhà xuất bản: Trẻ</p>
                            <div class="input-group">
                                <input type="number" id="quantity-SP022" class="form-control" name="quantity" value="1"
                                       min="1">
                                <button type="button" class="btn btn-primary" onclick="addToCart('SP022')">Thêm vào giỏ
                                    hàng
                                </button>
                            </div>
                        </div>
